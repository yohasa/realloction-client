...
import getOpps from '@salesforce/apex/AccountController.GetAccs';
...
const columns = [ // Remplacer par vos colonnes
    { type: 'checkbox', fieldName: 'selectRow', initialWidthType: 'auto'}, // Colonne de sélection
    { label: 'Id', fieldName: 'Id', type: 'Id', initialWidthType: 30},
    { label: 'Name', fieldName: 'Name', type: 'text', sortable: true, initialWidthType: 50},
    ...
    { label: 'Nom Vendeur', fieldName: 'LastName', type: 'text', sortable: true, initialWidthType: 50 },
